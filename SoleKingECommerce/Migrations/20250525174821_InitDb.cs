        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Hex = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GeneratedRecommendations = table.Column<int>(type: "int", nullable: false),
                    ErrorMessage = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecommendationBatches", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JaccardScore = table.Column<decimal>(type: "decimal(5,4)", nullable: false),
                    CommonProducts = table.Column<int>(type: "int", nullable: false),
                    TotalUniqueProducts = table.Column<int>(type: "int", nullable: false),
                    CalculatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserSimilarities", x => new { x.UserId1, x.UserId2 });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GiftProductQuantity = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DiscountConditions_Discounts_DiscountId",
                        column: x => x.DiscountId,
                        principalTable: "Discounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DiscountConditions_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                name: "UserProductRecommendations",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    SimilarUsersCount = table.Column<int>(type: "int", nullable: false),
                    SimilarUserIds = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GeneratedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ExpiresAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserProductRecommendations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserProductRecommendations_Products_RecommendedProductId",
                        column: x => x.RecommendedProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserProductRecommendations_Users_ForUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserPurchaseHistories_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserPurchaseHistories_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImportItems", x => new { x.ImportId, x.ProductVariantId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ImportItems_ProductVariants_ProductVariantId",
                        column: x => x.ProductVariantId,
                        principalTable: "ProductVariants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiscountConditions_DiscountId",
                table: "DiscountConditions",
                column: "DiscountId");

            migrationBuilder.CreateIndex(
                name: "IX_DiscountConditions_ProductId",
                table: "DiscountConditions",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ImportItems_ProductVariantId",
                table: "ImportItems",
                column: "ProductVariantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProductRecommendations_ForUserId_ExpiresAt",
                table: "UserProductRecommendations",
                columns: new[] { "ForUserId", "ExpiresAt" });

            migrationBuilder.CreateIndex(
                name: "IX_UserProductRecommendations_RecommendedProductId",
                table: "UserProductRecommendations",
                column: "RecommendedProductId");

            migrationBuilder.CreateIndex(
                name: "IX_UserProductRecommendations_Score",
                table: "UserProductRecommendations",
                column: "Score");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPurchaseHistories_UserId_ProductId",
                table: "UserPurchaseHistories",
